...
public record DataListLogs(String id, String cpf, Long quantity, LocalDateTime createdAt, Product product) {

    public DataListLogs(ProductLog productLog) {
        this(productLog.getId(), productLog.getCpf(), productLog.getQuantity(), productLog.getCreatedAt(), productLog.getProduct());
    }
}
